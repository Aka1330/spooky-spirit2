...
const appsRoute: Routes = [
    {
        ...
        component: lazy(() => import('@/views/writing/ProjectList')),
        authority: [ADMIN, USER],
    },
    {
        key: 'appsWriting.tips',
        path: `${APP_PREFIX_PATH}/writing/tips`,
        component: lazy(() => import('@/views/writing/ManageArticles')),
        authority: [ADMIN, USER],
    },
    {
        key: 'appsWriting.article',
        path: `${APP_PREFIX_PATH}/writing/article`,
        component: lazy(() => import('@/views/writing/Article')),
        authority: [ADMIN, USER],
    },
    {
    ...
    {
        key: 'appsWriting.issue',
        path: `${APP_PREFIX_PATH}/writing/issue`,
        component: lazy(() => import('@/views/writing/Issue')),
        authority: [ADMIN, USER],
    },
    {
        key: 'appsWriting.EditArticle',
        path: `${APP_PREFIX_PATH}/writing/EditArticle`,
        component: lazy(() => import('@/views/writing/EditArticle')),
        authority: [ADMIN, USER],
    },
    {
        key: 'appsReading.newTest',
        path: `${APP_PREFIX_PATH}/reading/newtest`,
        component: lazy(() => import('@/views/reading/Article')),
        authority: [ADMIN, USER],
    },
    {
        key: 'appsReading.test',
        path: `${APP_PREFIX_PATH}/reading/test`,
        component: lazy(() => import('@/views/reading/TestList')),
        authority: [ADMIN, USER],
    },
    {
        key: 'appsReading.tips',
        path: `${APP_PREFIX_PATH}/reading/tips`,
        component: lazy(() => import('@/views/reading/ManageArticles')),
        authority: [ADMIN, USER],
    },
    {
    ...
    //listening
    {
        ...
        component: lazy(() => import('@/views/listening/ProjectList')),
        authority: [ADMIN, USER],
    },
    {
        key: 'appsListening.tips',
        path: `${APP_PREFIX_PATH}/listening/tips`,
        component: lazy(() => import('@/views/listening/ManageArticles')),
        authority: [ADMIN, USER],
    },
    {
    ...
    //speaking
    {
        ...
        component: lazy(() => import('@/views/speaking/ProjectList')),
        authority: [ADMIN, USER],
    },
    {
        key: 'appsSpeaking.tips',
        path: `${APP_PREFIX_PATH}/speaking/tips`,
        component: lazy(() => import('@/views/speaking/ManageArticles')),
        authority: [ADMIN, USER],
    },
    {
